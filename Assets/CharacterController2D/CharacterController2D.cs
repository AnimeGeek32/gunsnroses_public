...
public class CharacterController2D : MonoBehaviour
{
    ...
    /// <summary>
    /// This method initiates a coroutine that disables collision with one-way platforms for set duration and then re-enables it.
    /// </summary>
    /// <param name="timeInSecs">Number of seconds</param>
    public void startTimedIgnoreOneWay(float timeInSecs)
    {
        if (!ignoreOneWayPlatformsThisFrame)
        {
            StartCoroutine(DisableOneWayCollisionAndEnableAgain(timeInSecs));
        }
    }
    ...
    /// <summary>
    /// A coroutine that handles one-way collision toggle at duration.
    /// </summary>
    /// <param name="timeInSecs">Number of seconds</param>
    /// <returns></returns>
    IEnumerator DisableOneWayCollisionAndEnableAgain(float timeInSecs)
    {
